	...
	<body>
        ...
        <div class="voucher-card">
            <div class="voucher-left">
                <img src="${pageContext.request.contextPath}/images/free-shipping.png" alt="vc">
                <p>Áp dụng toàn sàn</p>
            </div>
            <div class="voucher-right">
                <h3>Giảm tối đa ₫25k</h3>
                <p>Đơn Tối Thiểu ₫80k</p>
                <span class="tag">Mã số voucher: FS01</span>
                <p>HSD: 24.11.2024 </p>
            </div>
        </div>
        ...
        <div class="voucher-card">
            ...
            <div class="voucher-right">
                ...
                <span class="tag">Mã số voucher: FS02</span>
                <p>HSD: 24.11.2024</p>
            </div>
        </div>
        ...
        <div class="voucher-card">
            ...
            <div class="voucher-right">
                <h3>Giảm tối đa ₫25k</h3>
                <p>Đơn Tối Thiểu ₫80k</p>
                <span class="tag">Mã số voucher: FS03</span>
                <p>HSD: 24.11.2024</p>
            </div>
        </div>
		<!-- Voucher 1 -->
        <div class="voucher-card">
            ...
            <div class="voucher-right">
                <h3>Giảm tối đa ₫25k</h3>
                <p>Đơn Tối Thiểu ₫80k</p>
                <span class="tag">Mã số voucher: FS04</span>
                <p>HSD: 24.11.2024 </p>
            </div>
        </div>
        ...
        <div class="voucher-card">
            ...
            <div class="voucher-right">
                <h3>Giảm tối đa ₫15k</h3>
                <p>Đơn Tối Thiểu ₫25k</p>
                <span class="tag">Mã số voucher: FS05</span>
                <p>HSD: 24.11.2024</p>
            </div>
        </div>
        ...
        <div class="voucher-card">
            ...
            <div class="voucher-right">
                <h3>Giảm tối đa ₫25k</h3>
                <p>Đơn Tối Thiểu ₫80k</p>
                <span class="tag">Mã số voucher: FS06</span>
                <p>HSD: 24.11.2024</p>
            </div>
        </div>
		</div>
