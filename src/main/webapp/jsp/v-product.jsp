  ...
  <meta name="keywords" content="bootstrap, bootstrap4" />
	...
	<body>
        ...
        <div class="voucher-card">
            <div class="voucher-left2">
                <img src="${pageContext.request.contextPath}/images/gift-box.png" alt="vc">
                <p>Áp dụng toàn sàn</p>
            </div>
            <div class="voucher-right">
                <h3>Giảm tối đa ₫50k</h3>
                <p>Đơn Tối Thiểu ₫1tr</p>
                <span class="tag">Mã số voucher: PS01</span>
                <p>HSD: 24.11.2024 </p>
            </div>
        </div>
        ...
        <div class="voucher-card">
            ...
            <div class="voucher-right">
                <h3>Giảm tối đa ₫15k</h3>
                <p>Đơn Tối Thiểu ₫0k</p>
                <span class="tag">Mã số voucher: PS02</span>
                <p>HSD: 24.11.2024</p>
            </div>
        </div>
        ...
        <div class="voucher-card">
            ...
            <div class="voucher-right">
                <h3>Giảm tối đa ₫1tr</h3>
                <p>Đơn Tối Thiểu ₫7tr</p>
                <span class="tag">Mã số voucher: PS03</span>
                <p>HSD: 24.11.2024</p>
            </div>
        </div>
		<!-- Voucher 1 -->
        <div class="voucher-card">
            ...
            <div class="voucher-right">
                <h3>Giảm tối đa ₫40k</h3>
                <p>Đơn Tối Thiểu ₫500k</p>
                <span class="tag">Mã số voucher: PS04</span>
                <p>HSD: 24.11.2024 </p>
            </div>
        </div>
        ...
        <div class="voucher-card">
            ...
            <div class="voucher-right">
                <h3>Giảm tối đa ₫15k</h3>
                <p>Đơn Tối Thiểu ₫25k</p>
                <span class="tag">Mã số voucher: PS05</span>
                <p>HSD: 24.11.2024</p>
            </div>
        </div>
        ...
        <div class="voucher-card">
            ...
            <div class="voucher-right">
                <h3>Giảm tối đa ₫25k</h3>
                <p>Đơn Tối Thiểu ₫80k</p>
                <span class="tag">Mã số voucher: PS06</span>
                <p>HSD: 24.11.2024</p>
            </div>
        </div>
		</div>
